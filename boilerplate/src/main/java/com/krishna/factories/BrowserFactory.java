...
import com.krishna.listeners.WebActionListeners;
...
public class BrowserFactory {
	...
	private BrowserFactory() {
		System.out.println("Private constructor of BrowserFactory class");
	}
	...
	public synchronized static String getChromedriverPath() {
		...
		if(os.toLowerCase().contains("linux")) {
			return System.getProperty("user.dir") + "/src/test/resources/drivers/chromedriver_linux";
		}
		else if (os.toLowerCase().contains("mac")) {
			return System.getProperty("user.dir") + "/src/test/resources/drivers/chromedriver_mac";
		}
		else if (os.toLowerCase().contains("window")) {
			return System.getProperty("user.dir") + "/src/test/resources/drivers/chromedriver.exe";
		}
		else {
